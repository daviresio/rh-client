...
const INITIAL_STATE = {
    ...
    holerites: [],
    holerite: {},
    tiposAdicionaisSindicato: [],
    calculosProporcionalidades: [],
    calculosSaldoBeneficios: [],
    categoriasBeneficios: [],
    categoriasAnotacoes: [],
    coresRacas: [],
    sexos: [],
    estadosCivis: [],
    motivosAlteracoesSalario: [],
    motivosFaltasAfastamentos: [],
    tiposFaltasAfastamentos: [],
    categoriasLembretes: [],
    ...
    tiposAvisosPrevios: [],
    tiposDesligamentos: [],
    tiposCalculosHorasExtras: [],
    niveisEscolaridades: [],
    tiposHolerites: [],
    tiposProventos: [],
    tiposRecados: [],
    parcelasDecimosTerceiros: [],
};
