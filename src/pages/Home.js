...
const Home = () => {
    return (
        ...
        <div className={'home-resumos'}>
            <CardHome title={'Admissoes / Inclusoes pendentes'} qtd={2} color={'black'} button={'Incluir novo colaborador'}
                      message={'Colaboradores em admissao'} />
            <CardHome title={'Na ativa'} qtd={1} color={'green'} button={'Ir para colaboradores'}
