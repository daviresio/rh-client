...
const Toolbar = props => {
    ...
    const {empresaPesquisaVisible, usuarioOpcoesVisible} = props.toolbar
        ...
        <div className={'toolbar'}>
            ...
            <div className={'opcoes'}>
                ...
                <div className={'usuario'}>
                    ...
                    <div onClick={()=>changeUsuarioOpcoesVisibility(!usuarioOpcoesVisible)} className={'nome'}>{'DR'}</div>
